...
(async function () {
    ...
    const WS = 'StandardCrmContactQuestion';
    ...
    function updateGrid() {
        ...
        AWS.callSoap(WS, "listQuestions").then(function (res) {
            if (res.wsStatus === '0') {
                ...
                $$('status').setValue('Displaying ' + res.item.length + ' Prospect & Client Contact Questions');
            }
        });
    }
    ...
    $$('add').onclick(() => {
        ...
        $$('dp-title').setValue('Add Prospect & Company Contact Question');
        reset();
    ...
    function edit() {
        ...
        $$('dp-title').setValue('Edit Prospect & Company Contact Question');
    ...
    $$('delete').onclick(() => {
        Utils.yesNo('Confirmation', 'Are you sure you wish to delete the selected Prospect & Company Contact Question?', () => {
            const data = {
