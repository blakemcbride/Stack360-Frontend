...
Component.SearchEmployee.run = async (inData) => {
    ...
    $$('searchEmployeeSearch').onclick(async () => {
        const inParams = {
            ...
            firstNameSearchType: $$('employeeFirstNameCriteria').getValue(),  // searchApplicants
            lastName: $$('employeeLastNameSearch').getValue(),
            employeeLastNameSearchType: $$('employeeLastNameCriteria').getValue(),
            lastNameSearchType: $$('employeeLastNameCriteria').getValue(),    // searchApplicants
            ssn: $$('employeeSsnSearch').getValue(),
        };

        const data = await AWS.callSoap('StandardHrHrParent', method, inParams);
