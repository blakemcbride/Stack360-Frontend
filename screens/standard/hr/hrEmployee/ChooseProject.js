...
Component.ChooseProject.run = () => {
    ...
    $$('chooseProjectSearch').onclick(async () => {
        ...
        let data = await AWS.callSoap('StandardHrHrEmployee', 'searchProjects', inParams);
